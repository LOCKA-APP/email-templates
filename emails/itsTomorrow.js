...
export const itsTomorrow = (user_name, calendar_link, year) => {
                          ...
                          <tbody>
                            <tr>
                              <td align="center" style="font-size:0px;padding:0px 24px 48px 24px;word-break:break-word;">
                                <div style="font-family:Host Grotesk, Arial, sans-serif;font-size:30px;font-weight:bold;line-height:40px;text-align:center;color:#000000;">It’s Tomorrow!🚀 Take Control of Your Creative Earnings with Locka</div>
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Host Grotesk, Arial, sans-serif;font-size:16px;line-height:22.4px;text-align:left;color:#000000;">We’re just one day away from our webinar, “Take Control of Your Creative Earnings with Locka”.</div>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Host Grotesk, Arial, sans-serif;font-size:16px;line-height:22.4px;text-align:left;color:#000000;">Join us to hear Clarence Aigbuza share his creative journey, learn how to manage your creative income, and explore how Locka’s tools can help you stay in control of your creative earnings.</div>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                            ...
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Host Grotesk, Arial, sans-serif;font-size:16px;line-height:22.4px;text-align:left;color:#000000;">📅 Date: Saturday, 11th January</div>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                            ...
                            <tr>
                              <td align="center" style="font-size:0px;padding:18px 24px 48px 24px;word-break:break-word;">
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
                                  <tbody>
                                    <tr>
