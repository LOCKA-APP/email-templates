...
export const joinOurWebinar = (user_name, calendar_link, year) => {
                    ...
                    <tr>
                      <td style="background-color:#FFFFFF;border-radius:0px 0px 8px 8px;vertical-align:top;padding:48px 0;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                          <tbody>
                            <tr>
                              <td align="center" style="font-size:0px;padding:0px 24px 48px 24px;word-break:break-word;">
                                <div style="font-family:Host Grotesk, Arial, sans-serif;font-size:30px;font-weight:bold;line-height:40px;text-align:center;color:#000000;">Updated Webinar Details: Take Control of Your Creative Earnings</div>
                              </td>
                            </tr>
                            <tr>
                              <td align="center" style="font-size:0px;padding:0px 24px 48px 24px;word-break:break-word;">
                            ...
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Host Grotesk, Arial, sans-serif;font-size:16px;line-height:22.4px;text-align:left;color:#000000;">You are invited to an exclusive webinar on January 11th, 2025 with Clarence Aigbuza, our Product Lead. <br /> Join us to discover how you can Take Control of Your Creative Earning.</div>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Host Grotesk, Arial, sans-serif;font-size:16px;line-height:22.4px;text-align:left;color:#000000;"><b>Important Update: </b></div>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Host Grotesk, Arial, sans-serif;font-size:16px;line-height:22.4px;text-align:left;color:#000000;">The webinar link has been updated. Please click the button below to save your spot:</div>
                              </td>
                            </tr>
                            <tr>
                              <td align="center" style="font-size:0px;padding:20px 16px;word-break:break-word;">
                                  ...
                                  <tbody>
                                    <tr>
                                      <td align="center" bgcolor="#3B42C4" role="presentation" style="border:none;border-radius:8px;cursor:auto;height:30px;mso-padding-alt:10px 70px;background:#3B42C4;" valign="middle">
                                        <a href="${calendar_link}" style="display:inline-block;background:#3B42C4;color:#ffffff;font-family:Host Grotesk, Arial, sans-serif;font-size:16px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 70px;mso-padding-alt:0px;border-radius:8px;" target="_blank"> RVSP Here </a>
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
                            ...
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Host Grotesk, Arial, sans-serif;font-size:16px;line-height:22.4px;text-align:left;color:#000000;"><b> Key Takeaways: </b></div>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Host Grotesk, Arial, sans-serif;font-size:16px;line-height:22.4px;text-align:left;color:#333333;">
                                  <ul style="padding-left: 20px; margin: 0">
                                    <li> Strategies to take control of your income as a creative professional. </li>
                                    <li> Gain insights into how Locka supports creators with tools like project management, talent finding, and escrow services. </li>
                                    <li> Tips and best practices for managing creative earnings to maximise growth. </li>
                                    <li>Live demo on how to use Locka</li>
                                    <li>Connect with fellow creators and industry professionals</li>
                                  </ul>
                                </div>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Host Grotesk, Arial, sans-serif;font-size:16px;line-height:22.4px;text-align:left;color:#000000;">Whether you’re a creator trying to find new client or you want to secure your project payment, you’ll work away with actionable insight to take control of your earnings.</div>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Host Grotesk, Arial, sans-serif;font-size:16px;line-height:22.4px;text-align:left;color:#000000;">If the button above doesn’t work, please click or copy and paste the URL link below in your web browser</div>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Host Grotesk, Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#000000;"><a href="${calendar_link}" target="_blank" style="color: #3b42c4; font-weight: bold; text-decoration: none"> ${calendar_link} </a></div>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
