...
export const reminder = (user_name, meeting_link, year) => {
                          ...
                          <tbody>
                            <tr>
                              <td align="center" style="font-size:0px;padding:0px 24px 48px 24px;word-break:break-word;">
                                <div style="font-family:Host Grotesk, Arial, sans-serif;font-size:30px;font-weight:bold;line-height:40px;text-align:center;color:#000000;">Reminder: Take Control of your Creative Earnings Starts in 1 Hour</div>
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Host Grotesk, Arial, sans-serif;font-size:16px;line-height:22.4px;text-align:left;color:#000000;">Just a friendly reminder that our webinar, “Take Control of Your Creative Earnings with Locka” is happening today! Get ready to join us and:</div>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                            ...
                            <tr>
                              <td align="center" style="font-size:0px;padding:48px 24px 48px 24px;word-break:break-word;">
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
                                  <tbody>
                                    <tr>
